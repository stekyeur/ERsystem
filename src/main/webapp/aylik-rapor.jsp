...
<head>
  ...
  <title>Aylık Rapor - Hemşire İhtiyacı</title>
    ...
    <div class="col-lg-10">
      <div class="report-container">
        <div class="page-header">
          <h2><i class="fas fa-calendar-alt me-2"></i>Aylık Hemşire İhtiyacı Raporu</h2>
          <p class="lead text-muted"><i class="fas fa-calendar-check me-2"></i>Ay: <%= request.getAttribute("raporAyi") %></p>
        </div>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            %>
            <tr>
              <td colspan="3" class="text-center text-muted">Bu ay için veri bulunamadı.</td>
            </tr>
            <%
              }
            %>
